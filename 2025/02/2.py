...
def _repetition_sum(start, end, digits, repetitions, used_ids):
	...
	for number in range(start_sequence, end_sequence + 1):
		...
		if current_id > end:
			break
		# print(start, end, digits, repetitions, current_id)
		result += current_id
...
def silver(input_lines):
	...
	for i in ranges:
		...
		used_ids = set()
		if digits % 2 == 0:
			total_result += _repetition_sum(i[0], i[1], digits, 2, used_ids)
	return total_result
	# pass
